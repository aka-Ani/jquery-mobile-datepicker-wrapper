(function( $, undefined ) {
    ...
    inline: false
      ...
      addMobileStyle: function(){
          ...
          .find(".ui-datepicker-header").addClass("ui-body-"+this.options.datatheme+" ui-corner-top").removeClass("ui-corner-all").end()
          .find(".ui-datepicker-calendar th" ).addClass("ui-bar-"+this.options.datatheme).end()
          .find(".ui-datepicker-calendar td" ).addClass("ui-body-"+this.options.datatheme).end()
          .find(".ui-datepicker-calendar a.ui-state-active").addClass("ui-btn-active").end()
          .find(".ui-datepicker-calendar a.ui-state-highlight").addClass("ui-btn-up-"+this.options.datatheme).end().find(".ui-state-disabled").css("opacity","1");
      }
    });
